	...
	static void loadProfile(Elements tables, String outputPath) {
		try {
			...
			if (!f.exists()) {
				...
				for (Map.Entry<Integer, String> map : getLoadProfileHeaderData()
						.entrySet()) {
				...
				if (tableCount == 2 || tableCount == 4) {
					synchronized (table) {
						if (tableCount == 2) {
							...
							for (int i = 0; i < rows.size(); i++) { // first row
																	// is the
							...
							for (int i = 0; i < rows.size(); i++) { // first row
								...
								for (int j = 0; j < cols.size(); j++) {
									...
									if (value != null
											&& "Redo size:".equals(value)) {
										flag1 = true;
									} else if (value != null
											&& "Logical reads:".equals(value)) {
										flag2 = true;
									} else if (value != null
											&& "Block changes:".equals(value
													.trim())) {
										flag3 = true;
									} else if (value != null
											&& "Physical reads:".equals(value
													.trim())) {
										flag4 = true;
									} else if (value != null
											&& "Physical writes:".equals(value
													.trim())) {
										flag5 = true;
									} else if (value != null
											&& "User calls:".equals(value)) {
										flag6 = true;
									} else if (value != null
											&& "Parses:".equals(value)) {
										flag7 = true;
									} else if (value != null
											&& "Hard parses:".equals(value
													.trim())) {
										flag8 = true;
									} else if (value != null
											&& "Sorts:".equals(value.trim())) {
										flag9 = true;
									} else if (value != null
											&& "Logons:".equals(value.trim())) {
										flag10 = true;
									} else if (value != null
											&& "Executes:".equals(value.trim())) {
										flag11 = true;
									} else if (value != null
											&& "Transactions:".equals(value
													.trim())) {
										flag12 = true;
									}

									if (flag1) {
										csvData.put(1, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(2, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag2) {
										csvData.put(3, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(4, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag3) {
										csvData.put(5, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(6, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag4) {
										csvData.put(7, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(8, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag5) {
										csvData.put(9, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(10, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag6) {
										csvData.put(11, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(12, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag7) {
										csvData.put(13, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(14, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag8) {
										csvData.put(15, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(16, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag9) {
										csvData.put(17, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(18, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag10) {
										csvData.put(19, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(20, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag11) {
										csvData.put(21, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(22, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag12) {
										csvData.put(23, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(24, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}

									/*
									 * if(j==1 || j==2){ if(cols.get(j).text()
									 * != null &&
									 * !"".equals(cols.get(j).text().trim())){
									 * colsData
									 * .add(cols.get(j).text().replace("\u00a0",
									 * "")); }else{ colsData.add("0"); } }
									 */
									flag1 = false;
									flag2 = false;
	...
	static void loadTop5timedEvents(Elements tables, String outputPath) {
		try {
			...
			if (!f.exists()) {
				...
				for (Map.Entry<Integer, String> map : getHeaderData()
						.entrySet()) {
					colsMapHeader.add(map.getValue());
				}
				writer = new FileWriter(csvLocation, true);
			...
			for (Element table : tables) {
				...
				if (tableCount == 2 || tableCount == 8) {
					synchronized (table) {
						// csvPath = csvLocation + System.currentTimeMillis() +
						// ".csv";
						if (tableCount == 2) {
							Elements rows = table.select("tr");
							for (int i = 0; i < rows.size(); i++) { // first row
							...
							for (int i = 0; i < rows.size(); i++) { // first row
								...
								for (int j = 0; j < cols.size(); j++) {
									...
									if (cntFileFlag) {
										String val = cols.get(1).text()
												.replace("\u00a0", "");
										if (val != null
												&& !"".equals(val.trim())) {
											csvData.put(56, cols.get(1).text()
													.replaceAll(",", ""));
										}
										val = cols.get(2).text()
												.replace("\u00a0", "");
	...
	static void loadTableSpaceIostats(Elements tables, String outputPath) {
		try {
			...
			if (!f.exists()) {
				...
				for (Map.Entry<Integer, String> map : getIOStatsHeaderData()
						.entrySet()) {
					colsMapHeader.add(map.getValue());
				}
				writer = new FileWriter(csvLocation, true);
						...
						if (tableCount == 2) {
							...
							for (int i = 0; i < rows.size(); i++) { // first row
								...
								for (int j = 0; j < cols.size(); j++) {
									...
									String value = cols.get(0).text();
									if (value != null
											&& "CRELSCM_DATA".equals(value)) {
										flag1 = true;
									} else if (value != null
											&& "CRELSCM_INDX2".equals(value)) {
										flag2 = true;
									} else if (value != null
											&& "CRELSCM_INDX".equals(value
													.trim())) {
										flag3 = true;
									} else if (value != null
											&& "TEMP03".equals(value.trim())) {
										flag4 = true;
									} else if (value != null
											&& "CRELSCM_LOB".equals(value
													.trim())) {
										flag5 = true;
									} else if (value != null
											&& "UNDOTBS4".equals(value)) {
										flag6 = true;
									} else if (value != null
											&& "CRELSCM_INDX3".equals(value)) {
										flag7 = true;
									} else if (value != null
											&& "CRELSCM_LOB2".equals(value
													.trim())) {
										flag8 = true;
									} else if (value != null
											&& "CRELSCM_SHD2".equals(value
													.trim())) {
										flag9 = true;
									} else if (value != null
											&& "CRELSCM_SHD".equals(value
													.trim())) {
										flag10 = true;
									} else if (value != null
											&& "SYSAUX".equals(value.trim())) {
										flag11 = true;
									} else if (value != null
											&& "SYSTEM".equals(value.trim())) {
										flag12 = true;
									} else if (value != null
											&& "UNDOTBS2".equals(value)) {
										flag13 = true;
									} else if (value != null
											&& "CRELSCMS_DATA".equals(value
													.trim())) {
										flag14 = true;
									} else if (value != null
											&& "UNDOTBS1".equals(value.trim())) {
										flag15 = true;
									} else if (value != null
											&& "CRELSOMS_LOB".equals(value
													.trim())) {
										flag16 = true;
									} else if (value != null
											&& "CRELSCMS_SHD".equals(value)) {
										flag17 = true;
									} else if (value != null
											&& "UNDOTBS3".equals(value)) {
										flag18 = true;
									} else if (value != null
											&& "CRELSCMS_INDX".equals(value
													.trim())) {
										flag19 = true;
									} else if (value != null
											&& "CRELSCMS_LOB".equals(value
													.trim())) {
										flag20 = true;
									} else if (value != null
											&& "CRELSOMS_DATA".equals(value
													.trim())) {
										flag21 = true;
									} else if (value != null
											&& "USERS2".equals(value.trim())) {
										flag22 = true;
									} else if (value != null
											&& "CRELSOMS_INDX".equals(value
													.trim())) {
										flag23 = true;
									} else if (value != null
											&& "CRELSOMS_SHD".equals(value)) {
										flag24 = true;
									} else if (value != null
											&& "TIVOLIORTS"
													.equals(value.trim())) {
										flag25 = true;
											...
											&& "CRELSCM_DATA3".equals(value
													.trim())) {
										flag26 = true;
									} else if (value != null
											&& "USERS".equals(value.trim())) {
										flag27 = true;
									} else if (value != null
											&& "CRELSCMS_LOB1".equals(value)) {
										flag28 = true;
									} else if (value != null
											&& "CRELSCMS_LOB2".equals(value)) {
										flag29 = true;
									} else if (value != null
											&& "CRELSCMS_LOB3".equals(value
													.trim())) {
										flag30 = true;
									} else if (value != null
											&& "CRELSCMS_LOB4".equals(value
													.trim())) {
										flag31 = true;
									} else if (value != null
											&& "CRELSCM_DATA1".equals(value
													.trim())) {
										flag32 = true;
									} else if (value != null
											&& "CRELSCM_DATA2".equals(value
													.trim())) {
										flag33 = true;
									} else if (value != null
											&& "CRELSCM_LOB1".equals(value
													.trim())) {
										flag34 = true;
									} else if (value != null
											&& "CRELSCM_LOB3".equals(value)) {
										flag35 = true;
									} else if (value != null
											&& "CRELSCM_LOB4".equals(value
													.trim())) {
										flag36 = true;
									} else if (value != null
											&& "TEST_TS".equals(value.trim())) {
										flag37 = true;
									}
									...
									if (flag1) {
										...
										csvData.put(2, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(3, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(4, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(5, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(6, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(7, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(8, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag2) {
										...
										csvData.put(10, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(11, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(12, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(13, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(14, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(15, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(16, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag3) {
										...
										csvData.put(18, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(19, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(20, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(21, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(22, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(23, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(24, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag4) {
										csvData.put(25, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(26, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(27, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(28, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(29, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(30, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(31, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(32, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag5) {
										csvData.put(33, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(34, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(35, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(36, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(37, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(38, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(39, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(40, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag6) {
										csvData.put(41, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(42, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(43, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(44, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(45, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(46, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(47, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(48, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag7) {
										csvData.put(49, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(50, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(51, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(52, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(53, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(54, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(55, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(56, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag8) {
										csvData.put(57, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(58, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(59, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(60, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(61, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(62, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(63, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(64, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag9) {
										csvData.put(65, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(66, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(67, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(68, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(69, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(70, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(71, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(72, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag10) {
										csvData.put(73, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(74, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(75, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(76, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(77, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(78, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(79, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(80, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag11) {
										csvData.put(81, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(82, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(83, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(84, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(85, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(86, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(87, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(88, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag12) {
										csvData.put(89, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(90, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(91, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(92, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(93, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(94, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(95, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(96, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag13) {
										csvData.put(97, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(98, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(99, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(100, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(101, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(102, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(103, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(104, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag14) {
										csvData.put(105, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(106, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(107, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(108, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(109, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(110, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(111, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(112, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag15) {
										csvData.put(113, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(114, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(115, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(116, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(117, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(118, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(119, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(120, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag16) {
										csvData.put(121, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(122, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(123, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(124, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(125, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(126, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(127, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(128, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag17) {
										csvData.put(129, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(130, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(131, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(132, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(133, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(134, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(135, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(136, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag18) {
										csvData.put(137, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(138, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(139, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(140, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(141, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(142, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(143, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(144, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}

									if (flag19) {
										csvData.put(145, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(146, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(147, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(148, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(149, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(150, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(151, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(152, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag20) {
										csvData.put(153, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(154, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(155, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(156, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(157, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(158, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(159, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(160, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag21) {
										csvData.put(161, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(162, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(163, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(164, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(165, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(166, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(167, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(168, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag22) {
										csvData.put(169, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(170, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(171, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(172, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(173, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(174, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(175, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(176, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag23) {
										csvData.put(177, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(178, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(179, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(180, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(181, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(182, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(183, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(184, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag24) {
										csvData.put(185, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(186, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(187, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(188, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(189, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(190, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(191, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(192, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag25) {
										csvData.put(193, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(194, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(195, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(196, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(197, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(198, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(199, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(200, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag26) {
										csvData.put(201, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(202, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(203, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(204, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(205, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(206, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(207, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(208, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag27) {
										csvData.put(209, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(210, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(211, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(212, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(213, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(214, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(215, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(216, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag28) {
										csvData.put(217, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(218, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(219, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(220, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(221, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(222, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(223, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(224, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag29) {
										csvData.put(225, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(226, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(227, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(228, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(229, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(230, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(231, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(232, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag30) {
										csvData.put(233, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(234, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(235, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(236, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(237, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(238, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(239, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(240, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag31) {
										csvData.put(241, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(242, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(243, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(244, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(245, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(246, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(247, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(248, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag32) {
										csvData.put(249, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(250, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(251, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(252, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(253, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(254, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(255, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(256, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag33) {
										csvData.put(257, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(258, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(259, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(260, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(261, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(262, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(263, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(264, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag34) {
										csvData.put(265, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(266, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(267, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(268, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(269, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(270, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(271, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(272, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag35) {
										csvData.put(273, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(274, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(275, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(276, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(277, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(278, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(279, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(280, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag36) {
										csvData.put(281, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(282, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(283, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(284, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(285, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(286, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(287, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(288, cols.get(8).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
									if (flag37) {
										csvData.put(289, cols.get(1).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(290, cols.get(2).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(291, cols.get(3).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(292, cols.get(4).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(293, cols.get(5).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(294, cols.get(6).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
										csvData.put(295, cols.get(7).text()
												.replace("\u00a0", "")
												.replaceAll(",", ""));
									}
